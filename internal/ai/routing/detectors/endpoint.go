...
var endpointTerms = []term{
	...
	{word: "app.get", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "app.post", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "app.put", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "app.delete", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "app.patch", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "app.route", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "@app.route", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "@app.get", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "@app.post", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "@app.put", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	...
	{word: "addroute", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	{word: "registerhandler", surface: routing.SurfaceAuthorization, confidence: routing.ConfidenceMedium},
	...
	{word: "upload", surface: routing.SurfaceFilesystem, confidence: routing.ConfidenceMedium},
}
